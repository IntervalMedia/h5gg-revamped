...
H5GG_FILES = Tweak.mm h5gg.mm MemScan.mm MemoryResults.cpp MemoryValue.cpp MemoryFilter.cpp MemoryPage.cpp MemoryDump.cpp DylibTemplate.cpp BridgeMethods.cpp FileNames.cpp TargetSession.cpp ModalRequestQueue.cpp crossproc.mm FloatMenu.mm FloatButton.m FloatWindow.m TopShow.m ModalShow.mm makeDYLIB.mm makeWindow.m ldid-master/ldid.cpp ldid-master/lookup2.c
H5GG_COMMON_FLAGS =
